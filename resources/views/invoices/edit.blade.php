...
@section('title', ' اضافة فاتورة جديدة')
@section('content')
    <!-- row -->
    <div class="row">
        @if (session('Add'))
                            ...
                            <div class="col">
                                ...
                                <select name="Section" class="form-control">
                                    ...
                                    @foreach ($sections as $section)
                                        <option value="{{ $section->id }}" @selected($invoice->section_id == $section->id)>
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    Object.entries(data).forEach(([key, value]) => {
                        ...
                        productSelect.append(`<option value="${key}" ${selected}>${value}</option>`);
                    });
                }
            });
        }
