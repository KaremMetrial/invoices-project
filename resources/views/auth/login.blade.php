...
@section('css')
    ...
    <link href="{{ URL::asset('assets/plugins/sidemenu-responsive-tabs/css/sidemenu-responsive-tabs.css') }}"
        rel="stylesheet">
@endsection
@section('title', 'تسجيل الدخول - برنامج الفواتي')
@section('content')
                                ...
                                <div class="card-sigin">
                                    ...
                                    <div class="card-sigin">
                                        <div class="main-signup-header">
                                            <h2>اهلا بيك!</h2>
                                            <h5 class="font-weight-semibold mb-4">من فضل قم بتسجيل الدخول.</h5>
                                            <!-- Session Status -->
                                            ...
                                            <form action="{{ route('login') }}" method="POST">
                                                ...
                                                <div class="form-group">
                                                    <label for="password">{{ __('كلمة السر') }}</label> <input
                                                ...
                                                <button type = 'submit'
                                                    class="btn btn-main-primary btn-block">{{ __('تسجيل الدخول') }}</button>
