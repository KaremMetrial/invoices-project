                        ...
                        <div class="menu-header-content bg-primary text-right">
                            <div class="d-flex">
                                ...
                                <span class="badge badge-pill badge-warning mr-auto my-auto float-left">
                                    <a href="{{ route('mark-as-read-all') }}">تعين قراءة الكل</a>
                                </span>
                            </div>
                            <p id="notification_count" class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 "> عدد الاشعارات
                                الغير مقروءة : {{ auth()->user()->unreadNotifications()->count() }} </p>
                        </div>
                        <div id="notification_unread" class="main-notification-list Notification-scroll">
                            @forelse (auth()->user()->unreadNotifications as $notification)

                            <a class="d-flex p-3 border-bottom" href="{{ $notification->data['data']['actionURL'] ?? '#' }}">
                                ...
                                <div class="mr-3">
                                    <h5 class="notification-label mb-1">
                                        {{ $notification->data['data']['title'] . $notification->data['data']['user']['name']  ?? 'Notification' }}
                                    </h5>
