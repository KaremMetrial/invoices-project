			...
			<div class="main-sidemenu">
				<div class="app-sidebar__user clearfix">
					<div class="dropdown user-pro-body">
						<div class="">
							<img alt="user-img" class="avatar avatar-xl brround" src="{{ asset('image/profile.png')}}"><span class="avatar-status profile-status bg-green"></span>
						</div>
						<div class="user-info">
				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
                            @can('invoice_read')
							<li><a class="slide-item" href="{{ route('invoices.index') }}">قائمة القواتير</a></li>
                            @endcan
                            @can('invoice_paid')
                            ...
                            @endcan
                            @can('invoice_partial_paid')
							<li><a class="slide-item" href="{{ route('invoices.partial') }}">الفواتير المدفوعة جزئيا</a></li>
                            @endcan
                            @can('invoice_archive_list')
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ route('invoices-reports.index') }}">تقارير الفواتير</a></li>
							<li><a class="slide-item" href="{{ route('users-reports.index') }}">تقارير العملاء</a></li>
						</ul>
					</li>
